        ...
        if ($message) {
            ...
            <div id="message" class="notice notice-<?php echo $class; ?>">
                ...
                <?php if ($wp_http_referer) { ?>
                    <p>
                        <a href="<?php echo esc_url(wp_validate_redirect(esc_url_raw($wp_http_referer), admin_url('term.php?taxonomy=' . $taxonomy))); ?>">
        ...
        >
            ...
            <div class="edit-tag-actions">
                ...
                <?php if (current_user_can('delete_term', $tag->term_id)) : ?>
                    <span id="delete-link">
			<a class="delete"
               href="<?php echo admin_url(wp_nonce_url("edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id", 'delete-tag_' . $tag->term_id)); ?>"><?php _e('Delete'); ?></a>
		</span>
                <?php endif; ?>
