...
<footer id="colophon" class="site-footer" role="contentinfo">
    ...
    if (has_nav_menu('footer')) {
        ...
        <p id="site-generator" class="site-info centertext footer-copy">
            <a href="<?php echo esc_url(home_url('/')); ?>" rel="home">&copy;
                <?php echo esc_html(date('Y'));?>&nbsp;
                <?php bloginfo('name'); ?>.</a>
            <a href="<?php echo esc_url('https://wordpress.org/'); ?>" rel="generator">
                <?php esc_html_e('Proudly powered by WordPress', 'wordstar'); ?>.</a>
            <a href="<?php echo esc_url('https://linesh.com/projects/wordstar/'); ?>" rel="generator">
                <?php esc_html_e('WordStar', 'wordstar'); ?></a>,
            <a href="<?php echo esc_url('https://linesh.com/'); ?>" rel="generator">
                <?php esc_html_e('Theme by Linesh Jose', 'wordstar'); ?></a>
        </p>
    </div>
</footer>
</div>
