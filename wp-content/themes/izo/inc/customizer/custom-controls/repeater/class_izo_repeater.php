...
class Izo_Repeater_Control extends WP_Customize_Control {
		
	/**
	 * The type of control being rendered
	 */
	public $type = 'izo-sortable_repeater';
	/**
	 * Button labels
	 */
	...
	?>
		<div class="izo-sortable_repeater_control">
			...
			<div class="izo-sortable_repeater sortable">
				<div class="repeater">
