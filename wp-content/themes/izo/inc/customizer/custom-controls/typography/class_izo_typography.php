<?php
class Izo_Typography_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'izo-google_fonts';
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'izo-select2-js', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_style( 'izo-select2-css', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		...
		public function to_json() {
			parent::to_json();
			$this->json['izofontslist'] = $this->fontList;
		}
		/**
		...
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<p><strong><?php esc_html_e( 'Select the font weights', 'izo' ) ?></strong></p>

					<div style="margin: 0 -1%;">
						<?php if ( $this->input_attrs['disableRegular'] == false ) : ?>
						<div style="display:inline-block;width:30%;margin: 0 1%;">
							<div class="customize-control-description"><?php esc_html_e( 'Regular', 'izo' ) ?></div>
						...
						<div style="display:inline-block;width:30%;margin: 0 1%;">
							<div class="customize-control-description"><?php esc_html_e( 'Italic', 'izo' ) ?></div>
							<div class="weight-style">
						...
						<div style="display:inline-block;width:30%;margin: 0 1%;">
						<div class="customize-control-description"><?php esc_html_e( 'Bold', 'izo' ) ?></div>
							<div class="weight-style">
