        ...
        <div class="container ioebgdt">
            <div class="row">
				<div class="col-sm-7 text-left">		
					<h1 class="khaown-site-title"><?php _e('Searched: ', 'khaown'); ?><strong><?php echo get_search_query(); ?></strong></h1>					
				</div>
	...
	<section id="main" class="page-template">
        <div class="container">
            <div class="blog-posts em-site-content">
                <div class="row mt48">
					<?php 
						$sidebar_position = get_theme_mod("search_page_sidebar_position", "left-sidebar"); 
