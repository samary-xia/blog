...
//        $this->textdomain = isset($args['textdomain']) ? $args['textdomain'] : '';
            ...
            <div class="setting-field <?php if ($is_error) echo 'field-error'; ?>">
                ...
                <div class="field-input">%s
                    ...
                    <?php if ($is_error && !empty($error_details)): ?>
                        <p class="error-details"><i class="fas fa-exclamation-circle"></i> <?php echo $error_details; ?>
                        </p>
                    <?php endif; ?>
            ...
            field-media-wrapper-<?php echo $css_id; ?>">
                <div class="media-preview-wrap"
                    ...
                    if ("audio/mpeg" == $media_type) {
                        ?>
                        <div class="media-preview" class="dashicons dashicons-format-audio"
                ...
                <input class="media-input-value" type="hidden" name="<?php echo $field_name; ?>"
                       id="media_input_<?php echo $css_id; ?>" value="<?php echo $value; ?>"/>
                <div class="media-upload button"
                     id="media_upload_<?php echo $css_id; ?>"><?php echo __('Upload', $this->textdomain); ?></div>
                <div placeholder="<?php echo $placeholder; ?>" class="clear button"
                     id="media_clear_<?php echo $css_id; ?>"><?php echo __('Clear', $this->textdomain); ?></div>
        ...
        public function field_media_url($option)
        {
            ...
            field-media-wrapper-<?php echo $css_id; ?>">
                ...
                <input type="text" placeholder="<?php echo $placeholder; ?>" name="<?php echo $field_name; ?>"
                       id="media_input_<?php echo $css_id; ?>" value="<?php echo $value; ?>"/>
                <div class="media-upload button"
                     id="media_upload_<?php echo $css_id; ?>"><?php echo __('Upload', $this->textdomain); ?></div>
                <div class="clear button"
                     id="media_clear_<?php echo $css_id; ?>"><?php echo __('Clear', 'accordions'); ?></div>
                <div class="error-mgs"></div>
            </div>
        ...
        public function field_select($option)
        {
            ...
            <select <?php if ($multiple) echo 'multiple'; ?> name="<?php echo $field_name; ?>"
                                                             id="<?php echo $css_id; ?>">
                <?php
        ...
        public function field_select2($option)
        {
            ...
            ob_start();
            ?>
            <select <?php echo $attributes_html; ?> class="select2" <?php if ($multiple) echo 'multiple'; ?>
                                                    name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>">
                <?php
                foreach ($args as $key => $name):
        ...
        public function field_text_multi($option)
        {
            ...
            input-text-multi-wrapper-<?php echo $css_id; ?>">
                <span data-placeholder="<?php echo esc_attr($placeholder); ?>" data-sort="<?php echo $sortable; ?>"
                      data-clone="<?php echo $allow_clone; ?>" data-name="<?php echo $field_name; ?>[]"
        ...
        public function field_hidden($option)
        {
            ...
            ob_start();
            ?>
            <input type="hidden" class="" name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>"
                   placeholder="<?php echo $placeholder; ?>" value="<?php echo esc_attr($value); ?>"/>
            <?php
        ...
        public function field_text($option)
        {
            ...
            ob_start();
            ?>
            <input type="text" class="" name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>"
                   placeholder="<?php echo $placeholder; ?>" value="<?php echo esc_attr($value); ?>"/>
            <?php
        ...
        public function field_text_icon($option)
        {
            ...
            ?>
            <div class="text-icon">
                <span class="icon"><?php echo $option_value; ?></span><input type="text" class=""
        ...
        public function field_range($option)
        {
            ...
            <div class="range-input">
                <span class="range-value"><?php echo $value; ?></span><input type="range"
                                                                             min="<?php if ($min) echo $min; ?>"
                                                                             max="<?php if ($max) echo $max; ?>"
                                                                             step="<?php if ($step) echo $step; ?>"
                                                                             class="" name="<?php echo $field_name; ?>"
                                                                             id="<?php echo $css_id; ?>"
        ...
        public function field_textarea($option)
        {
            ...
            ob_start();
            ?>
            <textarea name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>" cols="40" rows="5"
        ...
        public function field_textarea_editor($option)
        {
            ...
            ob_start();
            ?>
            <textarea editor_enabled="no" class="textarea-editor" name="<?php echo $field_name; ?>"
                      id="<?php echo $css_id; ?>" cols="40" rows="5"
                      placeholder="<?php echo $placeholder; ?>"><?php echo $value; ?></textarea>
            <?php
                ...
                <div class="field-input">
                    ...
                    if (!empty($args))
                        foreach ($args as $key => $value):
                            ...
                            ?>
                            <label for='<?php echo $for; ?>'><input name='<?php echo $field_name; ?>[]' type='checkbox'
                                                                    id='<?php echo $for; ?>'
                                                                    value='<?php echo $key; ?>' <?php echo $checked; ?>><span><?php echo $value; ?></span></label>
        ...
        public function field_radio($option)
        {
            ...
            if (!empty($args))
                foreach ($args as $key => $value):
                    ...
                    ?>
                    <label for="<?php echo $for; ?>"><input name="<?php echo $field_name; ?>" type="radio"
                                                            id="<?php echo $for; ?>"
                                                            value="<?php echo $key; ?>" <?php echo $checked; ?>><span><?php echo $value; ?></span></label>
            ...
            <div class="radio-img">
                ...
                foreach ($args as $key => $value):
                    ...
                    <label title="<?php echo $name; ?>"
                        ...
                        <input <?php if ($disabled) echo 'disabled'; ?> name="<?php echo $field_name; ?>" type="radio"
                                                                        id="<?php echo $css_id; ?>-<?php echo $key; ?>"
                                                                        value="<?php echo $key; ?>" <?php echo $checked; ?>>

                        <?php
                        if (!empty($thumb)):
                            ?>
                            <img style="width: <?php echo $width; ?>;" alt="<?php echo $name; ?>"
                                 src="<?php echo $thumb; ?>">
        ...
        public function field_datepicker($option)
        {
            ...
            ob_start();
            ?>
            <input type="text" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>"
                   placeholder="<?php echo $placeholder; ?>" value="<?php echo $value; ?>"/>
            <script>jQuery(document).ready(function ($) {
                    $("#<?php echo $css_id; ?>").datepicker({dateFormat: "<?php echo $format; ?>"});
                });</script>
            <?php
        ...
        public function field_colorpicker($option)
        {
            ...
            ob_start();
            ?>
            <input colorPicker="" name="<?php echo $field_name; ?>" id="<?php echo $css_id; ?>"
            ...
            if (!empty($args)):
                ...
                foreach ($args as $arg_key => $arg):
                    ...
                    <div class="">
                        ...
                        <input name="<?php echo $field_name; ?>[<?php echo $arg_key; ?>]"
                               id="<?php echo $arg_key . '-' . $css_id; ?>" value="<?php echo $item_value; ?>"/>
                        <script>jQuery(document).ready(function ($) {
