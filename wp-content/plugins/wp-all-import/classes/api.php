        ...
        switch ($field_type) {
            ...
            case 'enum':
                ...
                <div class="form-field wpallimport-radio-field wpallimport-<?php echo sanitize_title($params['field_name']); ?>_xpath">
                    <input type="radio" id="<?php echo sanitize_title($params['field_name']); ?>_xpath" class="switcher"
                           name="<?php echo $params['field_name']; ?>"
										...
										<?php if ($params['mapping']): ?>
                                            ...
                                            <div class="input wpallimport-custom-fields-actions">
												<a href="javascript:void(0);"
                                                   class="wpallimport-cf-options"><?php _e('Field Options...', 'wp_all_import_plugin'); ?></a>
												<ul id="wpallimport-cf-menu-<?php echo sanitize_title($params['field_name']); ?>"
													...
													<li class="<?php echo (!empty($custom_mapping_rules)) ? 'active' : ''; ?>">
														<a href="javascript:void(0);"
                                                           ...
                                                           rel="cf_mapping_<?php echo sanitize_title($params['field_name']); ?>"><?php _e('Mapping', 'wp_all_import_plugin'); ?></a>
													</li>
												</ul>														
											</div>
                                            <div id="cf_mapping_<?php echo sanitize_title($params['field_name']); ?>"
												...
												<fieldset>
													<table cellpadding="0" cellspacing="5" class="cf-form-table"
														...
														<tbody>	
															...
															<tr>
																<td colspan="3">
																	<a href="javascript:void(0);"
                                                                       title="<?php _e('Add Another', 'wp_all_import_plugin') ?>"
                                                                       class="action add-new-key add-new-entry"><?php _e('Add Another', 'wp_all_import_plugin') ?></a>
																</td>
															</tr>
															<tr>																										
																<td colspan="3">
																	<div class="wrap" style="position:relative;">
																		<a class="save_popup save_mr"
                                                                           href="javascript:void(0);"><?php _e('Save Rules', 'wp_all_import_plugin'); ?></a>
																	</div>
																</td>
															</tr>
														</tbody>
													...
													<input type="hidden" class="pmre_mapping_rules"
                                                           ...
                                                           value="<?php if (!empty($params['mapping_rules'])) echo esc_html($params['mapping_rules']); ?>"/>
												</fieldset>
											</div>
                                        <?php endif; ?>
									</td>
            ...
            case 'wp_editor':
                ?>
                <div id="<?php echo (user_can_richedit() ? 'postdivrich' : 'postdiv') . sanitize_title($params['field_name']); ?>"
                     class="postarea">
                ...
                <div class="input">
                    <div class="input" style="margin: 0px;">
                        ...
                        <a href="#help" class="wpallimport-help"
                           title="<?php _e('http:// or https://', 'wp_all_import_plugin') ?>"
                           style="position: relative; top: -2px;">?</a>
                    </div>
                    <div class="input" style="margin: 0px;">
            ...
            case 'accordion':
                ...
                ?>
                <div class="wpallimport-collapsed closed wpallimport-section <?php echo(($in_the_bottom and $is_full_width) ? 'wpallimport-sub-options-full-width' : 'wpallimport-sub-options');
