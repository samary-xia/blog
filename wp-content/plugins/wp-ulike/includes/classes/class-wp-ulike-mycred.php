                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->field_name(array('add_like' => 'creds')); ?>"
                                   ...
                                   value="<?php echo $this->core->number($prefs['add_like']['creds']); ?>"
                                   class="form-control"/>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->field_name(array('get_like' => 'creds')); ?>"
                                   ...
                                   value="<?php echo $this->core->number($prefs['get_like']['creds']); ?>"
                                   class="form-control"/>
                            <span class="description"><?php _e('Use zero to disable.', WP_ULIKE_SLUG); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->field_name(array('add_unlike' => 'creds')); ?>"
                                   ...
                                   value="<?php echo $this->core->number($prefs['add_unlike']['creds']); ?>"
                                   class="form-control"/>
                            <span class="description"><?php _e('Use zero to disable.', WP_ULIKE_SLUG); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->field_name(array('get_unlike' => 'creds')); ?>"
                                   ...
                                   value="<?php echo $this->core->number($prefs['get_unlike']['creds']); ?>"
                                   class="form-control"/>
                            <span class="description"><?php _e('Use zero to disable.', WP_ULIKE_SLUG); ?></span>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <label for="<?php echo $this->field_id(array('limits' => 'self_reply')); ?>"><input
                                            type="checkbox"
                                            name="<?php echo $this->field_name(array('limits' => 'self_reply')); ?>"
                                            id="<?php echo $this->field_id(array('limits' => 'self_reply')); ?>" <?php checked($prefs['limits']['self_reply'], 1); ?>
                                            value="1"/> <?php echo $this->core->template_tags_general(__('%plural% is to be awarded even when item authors Like/Unlike their own item.', WP_ULIKE_SLUG)); ?>
                                </label>
                            </div>
                        </div>
                    </div>
